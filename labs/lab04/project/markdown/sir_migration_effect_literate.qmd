...
Скрипт анализирует влияние интенсивности перемещений между городами
на скорость распространения инфекции и величину эпидемического пика.
...
## Определение функции эксперимента

```{julia}
function peak_time(p)

    migration_rates = create_migration_matrix(
        p[:C],
