...
![Julia 1.12.6, инициализация DrWatson, установка зависимостей](image/2026-06-11--drwatson-init__julia_drwatson_install.png){width=85%}
...
![Pkg.add("Distributions") и загрузка sir_model.jl](image/2026-06-11--distributions-install__julia_pkg_distributions.png){width=85%}
...
![sir_model.jl: тип агента Person](image/2026-06-11--sir-model-struct__julia_agents_person.png){width=100%}

:::
::: {.column width="50%"}

![sir_run_basic.jl: словарь параметров](image/2026-06-11--sir-run-basic-script__julia_sir_params.png){width=100%}
...
![Запуск в Julia REPL](image/2026-06-11--sir-run-basic-repl__julia_sir_run.png){width=100%}

:::
::: {.column width="50%"}

![Файлы JLD2 в каталоге data/](image/2026-06-11--jld2-files-manager__julia_jld2_save.png){width=100%}
...
![sir_scan_beta.jl: функция run_experiment](image/2026-06-11--sir-scan-beta-script__julia_sir_beta.png){width=85%}
...
![30 завершённых экспериментов, beta_scan.png справа](image/2026-06-11--sir-scan-beta-terminal__julia_sir_beta_run.png){width=85%}
...
![Функция create_migration_matrix](image/2026-06-11--sir-migration-script__julia_sir_migration.png){width=100%}

:::
::: {.column width="50%"}

![18 экспериментов завершены](image/2026-06-11--sir-migration-terminal__julia_sir_migration_run.png){width=100%}
...
![sir_optimize_parameters.jl: cost_multi](image/2026-06-11--sir-optimize-script__julia_sir_blackboxoptim.png){width=100%}

:::
::: {.column width="50%"}

![sir_visualize_dynamics.jl: построение графиков](image/2026-06-11--sir-visualize-script__julia_sir_visualize.png){width=100%}
...
![sir__run_basic.jl](image/2026-06-12--sir-run-basic-literate__julia_literate_style.png){width=100%}

:::
::: {.column width="50%"}

![sir_migration_effect_literate.jl](image/2026-06-12--sir-migration-literate__julia_literate_style.png){width=100%}
...
![sir_optimize_parameters_literate.jl](image/2026-06-12--sir-optimize-literate__julia_literate_style.png){width=100%}

:::
::: {.column width="50%"}

![sir_scan_beta_literate.jl](image/2026-06-12--sir-scan-beta-literate__julia_literate_style.png){width=100%}
...
![sir_migration_effect_literate.ipynb](image/2026-06-12--jupyter-migration-notebook__jupyter_ipynb.png){width=100%}

:::
::: {.column width="50%"}

![sir__run_basic.ipynb: параметры модели](image/2026-06-12--jupyter-run-basic-notebook__jupyter_ipynb.png){width=100%}
...
![sir_scan_beta_literate.ipynb](image/2026-06-12--jupyter-scan-beta-notebook__jupyter_ipynb.png){width=100%}

:::
::: {.column width="50%"}

![DataFrame 30×13: beta_scan_all.csv](image/2026-06-12--jupyter-visualize-notebook__jupyter_dataframe.png){width=100%}
...
![sir_migration_effect_literate.html](image/2026-06-12--quarto-migration-html__quarto_render.png){width=100%}

:::
::: {.column width="50%"}

![sir__run_basic.html](image/2026-06-12--quarto-run-basic-html__quarto_render.png){width=100%}
...
![sir_visualize_dynamics_literate.html: DataFrame в документе](image/2026-06-12--quarto-visualize-html__quarto_render.png){width=85%}
