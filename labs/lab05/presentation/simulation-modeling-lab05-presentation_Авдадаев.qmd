---
title: "Лабораторная работа №5: Исследование задачи обедающих философов средствами сетей Петри"
...
![Структура PetriNet и экспортируемые функции модуля](image/2026-06-12--petri-module-struct__julia_petri_module.png){width=85%}
...
![dining_philosophers.jl: базовый эксперимент](image/2026-06-12--dining-base-script__julia_petri_dining.png){width=85%}
...
![Deadlock обнаружен: true (классика) / false (арбитр)](image/2026-06-12--deadlock-result__julia_petri_deadlock.png){width=85%}
...
![dining_philosophers_literate.jl](image/2026-06-12--dining-literate-script__julia_literate_style.png){width=85%}
...
![Literate.notebook и Literate.markdown с QuartoFlavor](image/2026-06-12--literate-notebook-quarto__julia_literate_output.png){width=85%}
...
![dining_philosophers_parametrized_literate.jl](image/2026-06-12--dining-parametrized-script__julia_petri_parametric.png){width=85%}
...
![Таблица deadlock_classic / deadlock_arbiter для N = 3, 5, 7](image/2026-06-12--parametric-deadlock-table__julia_petri_results.png){width=85%}
