...
где:
* $S$ - восприимчивые к инфекции индивиды
...
Выбираем временной шаг 0.1 дня и период моделирования 40 дней,
что позволяет наблюдать полный цикл эпидемии.
...
Начальные условия: в популяции из 1000 человек изначально
10 инфицированных, остальные восприимчивы к инфекции
...
- γ = 0.25 (скорость выздоровления, средняя длительность болезни 4 дня)

```{julia}
p = [0.05, 10.0, 0.25] # β, c, γ
```

Расчет базового репродуктивного числа - ожидаемое число вторичных случаев
заболевания от одного инфицированного в полностью восприимчивой популяции
...
На этом графике показана динамика всех трех групп населения во времени.
...
Фокус на группе инфицированных с выделением пика эпидемии.
...
## График долей населения

Динамика в процентах от общей численности населения.
...
Взаимосвязь между количеством восприимчивых и инфицированных.
...
$R_e(t) = R_0 \frac{S(t)}{N}$ - текущий показатель распространения инфекции.
